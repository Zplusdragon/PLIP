...
def create_optimizer(params,args):
    if args.optimizer =="adam":
        print("The optimizer is {}".format(args.optimizer))
        optimizer = torch.optim.Adam(params,lr=args.lr, betas=(args.adam_alpha, args.adam_beta), eps=args.epsilon)
        return optimizer
    elif args.optimizer =="adan":
        print("The optimizer is {}".format(args.optimizer))
        optimizer = Adan(params, lr=args.lr, weight_decay=args.adan_weight_decay, betas=args.adan_opt_betas, eps=args.adan_opt_eps,
                         max_grad_norm=args.adan_max_grad_norm, no_prox=args.adan_no_prox)
        return optimizer